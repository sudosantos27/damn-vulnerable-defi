...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        // we connect to the contracts with the attaacker account
        ...
        // function to get current token/eth balances
        ...
        // we approve token to swap with uniswap
        await attackToken.approve(attackUniSwap.address, ATTACKER_INITIAL_TOKEN_BALANCE);
        console.log("Balance approved");

        // calculate ETH pay out, how many ETH we received from depositing the tokens
        ...
        console.log("Transfering tokens for ETH");
        ...
        // we deposit ETH required to gain ALL tokens from pool
        ...
        // get 1000 tokens back by swapping ETH
